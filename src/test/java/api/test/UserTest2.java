...
import api.endpoint.UserEndPointFromPopert;
...
public class UserTest2 {
	...
	public void setupData()
	{
		...
		l=LogManager.getLogger(UserTest2.class);
	}
...
//		u.setUsername(f.name().username());
		...
		Response r=UserEndPointFromPopert.postMethod(u);
		r.then()
		       .statusCode(200)
		       .log().body();
...
//		username=s.getUsername();
	...
	public void getMethod()
	{
		...
		Response r=UserEndPointFromPopert.getMethod(this.u.getUsername());
		r.then()
		       .statusCode(200)
		       .log().body();
	...
	public void UpdateUesrs()
	{
		...
		UserEndPointFromPopert.updateMethod(u,this.u.getUsername());

		Response r1=UserEndPointFromPopert.getMethod(this.u.getUsername());
		r1.then()
		       .statusCode(200)
		       .log().body();
	...
	{
		l.info("Delete data ");
		Response r=UserEndPointFromPopert.deleteMethod(u.getUsername());
		r.then()
		       .statusCode(200);
